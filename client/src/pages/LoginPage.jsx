...
const LoginPage = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      // 🧠 Added a small 400ms timeout to ensure the AuthContext state has completely 
      // written the JWT tokens to localStorage before React Router evaluates the route guard.
      setTimeout(() => {
        navigate('/dashboard');
      }, 400);
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-[#0f172a] overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          className="absolute bottom-[-15%] right-[-10%] w-[500px] h-[500px] rounded-full bg-gradient-to-tr from-blue-400/15 to-cyan-500/5 blur-3xl"
        ...
        />
        <div
          className="absolute bottom-[30%] left-[15%] w-[250px] h-[250px] rounded-full bg-gradient-to-tr from-blue-500/10 to-emerald-400/5 blur-3xl"
